...
import { setKeyWord, showKeywordError } from "../../state/slices/search/search_slice";
import {
  setNewIngredient,
  addIngredient,
  removeIngredient,
...
import { clearRecipes } from "../../state/slices/recipes/recipes_slice.js";
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center mb-4">
          ...
          >
            <IoIosAddCircleOutline className="text-2xl" data-testid="add-icon" />
          </Button>
        </div>
        {ingredientError && (
          <p className="text-red-500 text-sm mb-2" data-testid="ingredient-error">
            {ingredientError}
          </p>
        )}
      ...
      {isLoading ? <CircularProgress className="mt-6" /> :
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <div className="p-4 border border-gray-500 bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded shadow-lg w-96">
          ...
          <p className="mb-4">Are you sure you want to clear all ingredients?</p>
